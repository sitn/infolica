...
select numb.id as numero_base_id, cadb.nom as numero_base_cadastre, numtb.nom as numero_base_type, numb.numero as numero_base_numero, numb.suffixe as numero_base_suffixe, numeb as numero_base_etat, numb.plan_id as numero_base_plan_id,
numa.id as numero_associe_id, cada.nom as numero_associe_cadastre, numta.nom as numero_associe_type, numa.numero as numero_associe_numero, numa.suffixe as numero_associe_suffixe, numea as numero_associe_etat, numa.plan_id as numero_associe_plan_id,
