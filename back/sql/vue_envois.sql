...
select env.id as id, aff.id as affaire_id, aff.nom as affaire_nom, cl.id as client_id, cl.entreprise as client_entreprise, cl.titre as client_titre, cl.nom as client_nom,
