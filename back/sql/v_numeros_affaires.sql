...
num.suffixe as numero_suffixe, nume.nom as numero_etat, affnumt.nom as affaire_numero_type, tmp.numero_base_id as numero_base_id, 
...
on affnum.affaire_id = tmp.affaire_id and affnum.numero_id = tmp.numero_associe_id, infolica.affaire as aff, 
infolica.affaire_type as afft, infolica.numero as num, infolica.cadastre as cad, infolica.numero_type as numt, infolica.numero_etat as nume, 
