...
select affnum.numero_id as numero_id, aff.id as affaire_id, aff.nom as affaire_nom, afft.nom as affaire_type, aff.date_ouverture as affaire_date, aff.information as affaire_information
