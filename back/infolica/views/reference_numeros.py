...
def reference_numeros_new_view(request):
    try:
        ...
        numeros_liste = json.loads(request.params['numeros_liste']) if 'numeros_liste' in request.params else None
        ...
        for numero_i in numeros_liste:
            ...
            params = Utils._params(numero_id=numero_i['numero_id'], numero_etat_id=numero_i['etat_id'])
