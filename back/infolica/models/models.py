...
class ControleGeometre(Base):
    ...
    id = Column(BigInteger, primary_key=True, autoincrement=True)
    affaire_id = Column(BigInteger, ForeignKey(Affaire.id), nullable=False)
    ctrl_juridique_operateur_id = Column(BigInteger, ForeignKey(Operateur.id))
    ctrl_juridique_date = Column(Date)
    ctrl_juridique_remarque = Column(Text)
    signature_operateur_id = Column(BigInteger, ForeignKey(Operateur.id))
    signature_date = Column(Date)
    signature_remarque = Column(Text)
    ...
    des_tampon_duplicata_dates = Column(Integer, default=-1)
    ...
    lettres_emoluments = Column(Integer, default=-1)
