...
Revision ID: d36235de99bc
Revises: 7a2fe1dd0759
Create Date: 2021-03-15 19:56:44.317645
...
revision = 'd36235de99bc'
down_revision = '7a2fe1dd0759'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.drop_constraint('uq_numero_cadastre_id', 'numero', type_='unique')
    op.create_unique_constraint(op.f('uq_numero_cadastre_id'), 'numero', ['cadastre_id', 'numero'], schema='infolica')
...
def downgrade():
    ...
    op.drop_constraint(op.f('uq_numero_cadastre_id'), 'numero', schema='infolica', type_='unique')
    op.create_unique_constraint('uq_numero_cadastre_id', 'numero', ['cadastre_id', 'type_id', 'numero', 'suffixe'])
