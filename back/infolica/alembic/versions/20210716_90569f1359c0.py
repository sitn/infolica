"""add unique constraint on numero_relation

Revision ID: 90569f1359c0
Revises: cd2fb3237edb
Create Date: 2021-07-16 16:28:00.212973
...
revision = '90569f1359c0'
down_revision = 'cd2fb3237edb'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_unique_constraint(op.f('uq_numero_relation_numero_id_base'), 'numero_relation', ['numero_id_base', 'numero_id_associe', 'relation_type_id', 'affaire_id'], schema='infolica')
...
def downgrade():
    ...
    op.drop_constraint(op.f('uq_numero_relation_numero_id_base'), 'numero_relation', schema='infolica', type_='unique')
