...
def upgrade():
    ...
    sa.Column('ctrl_juridique_operateur_id', sa.BigInteger(), nullable=True),
    sa.Column('ctrl_juridique_date', sa.Date(), nullable=True),
    sa.Column('ctrl_juridique_remarque', sa.Text(), nullable=True),
    sa.Column('signature_operateur_id', sa.BigInteger(), nullable=True),
    sa.Column('signature_date', sa.Date(), nullable=True),
    sa.Column('signature_remarque', sa.Text(), nullable=True),
    ...
    sa.Column('des_tampon_duplicata_dates', sa.Integer(), nullable=True),
    ...
    sa.Column('lettres_emoluments', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['affaire_id'], ['infolica.affaire.id'], name=op.f('fk_controle_geometre2_affaire_id_affaire')),
    sa.ForeignKeyConstraint(['ctrl_juridique_operateur_id'], ['infolica.operateur.id'], name=op.f('fk_controle_geometre2_ctrl_juridique_operateur_id_operateur')),
    sa.ForeignKeyConstraint(['signature_operateur_id'], ['infolica.operateur.id'], name=op.f('fk_controle_geometre2_signature_operateur_id_operateur')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_controle_geometre2')),
    schema='infolica'
    )
