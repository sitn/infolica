...
Revision ID: ee79f1259c77
Revises: 7e2ca4f17831
Create Date: 2021-08-27 17:06:20.907145
...
revision = 'ee79f1259c77'
down_revision = '7e2ca4f17831'
branch_labels = None
depends_on = None

def upgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('emolument',
    sa.Column('emolument_affaire_id', sa.BigInteger(), nullable=False),
    sa.Column('tableau_emolument_id', sa.BigInteger(), nullable=False),
    sa.Column('position', sa.Text(), nullable=False),
    sa.Column('prix_unitaire', sa.Float(), nullable=True),
    sa.Column('nombre', sa.Integer(), nullable=True),
    sa.Column('batiment', sa.Integer(), nullable=False),
    sa.Column('batiment_f', sa.Float(), nullable=True),
    sa.Column('montant', sa.Float(), nullable=True),
    sa.PrimaryKeyConstraint('emolument_affaire_id', 'tableau_emolument_id', 'position', 'batiment', name=op.f('pk_emolument')),
    schema='infolica'
    )
    op.create_table('emolument_affaire',
    sa.Column('id', sa.BigInteger(), autoincrement=True, nullable=False),
    sa.Column('affaire_id', sa.BigInteger(), nullable=True),
    sa.Column('pente_pc', sa.Integer(), nullable=True),
    sa.Column('diff_visibilite_pc', sa.Integer(), nullable=True),
    sa.Column('trafic_pc', sa.Integer(), nullable=True),
    sa.Column('zi', sa.Float(), nullable=True),
    sa.Column('indice_application', sa.Float(), nullable=True),
    sa.Column('tva_pc', sa.Float(), nullable=True),
    sa.Column('remarque', sa.Text(), nullable=True),
    sa.Column('numeros_id', sa.ARRAY(sa.BigInteger()), nullable=True),
    sa.Column('facture_type_id', sa.BigInteger(), nullable=True),
    sa.Column('utilise', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['affaire_id'], ['infolica.affaire.id'], name=op.f('fk_emolument_affaire_affaire_id_affaire')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_emolument_affaire')),
    schema='infolica'
    )
    ...
    op.add_column('client', sa.Column('besoin_vref_facture', sa.Boolean(), nullable=True))
    ...
    op.add_column('numero_differe', sa.Column('req_ref', sa.Text(), nullable=True))
    op.add_column('numero_differe', sa.Column('date_controle', sa.Date(), nullable=True))
...
def downgrade():
    ...
    op.drop_column('numero_differe', 'date_controle')
    op.drop_column('numero_differe', 'req_ref')
    ...
    op.drop_column('client', 'besoin_vref_facture')
    ...
    op.drop_table('emolument_affaire', schema='infolica')
    op.drop_table('emolument', schema='infolica')
    # ### end Alembic commands ###
