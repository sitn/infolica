...
Revision ID: 7a2fe1dd0759
Revises: 1d8dea9431da
Create Date: 2021-03-03 17:17:55.642040
...
revision = '7a2fe1dd0759'
down_revision = '1d8dea9431da'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.drop_index('idx_geos_balance_geom', table_name='geos_balance')
    op.drop_index('idx_mo_distr_plan_geom', table_name='mo_distr_plan')
    ...
    op.add_column('modification_affaire_type', sa.Column('affaire_destination_type_id', sa.BigInteger(), nullable=True))
...
def downgrade():
    ...
    op.drop_column('modification_affaire_type', 'affaire_destination_type_id')
    ...
    op.create_index('idx_mo_distr_plan_geom', 'mo_distr_plan', ['geom'], unique=False)
    op.create_index('idx_geos_balance_geom', 'geos_balance', ['geom'], unique=False)
