...
Revision ID: 57d533765958
Revises: bdc5b448f5ea
Create Date: 2021-07-21 17:00:57.482273
...
revision = '57d533765958'
down_revision = 'bdc5b448f5ea'
branch_labels = None
depends_on = None

def upgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table('notes_maj',
    ...
    sa.Column('delai', sa.Date(), nullable=False),
    sa.ForeignKeyConstraint(['operateur_id'], ['infolica.operateur.id'], name=op.f('fk_notes_maj_operateur_id_operateur')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_notes_maj')),
    schema='infolica'
    )
    ...
    op.drop_column('numero_differe', 'requisition')
...
def downgrade():
    ...
    op.add_column('numero_differe', sa.Column('requisition', sa.TEXT(), autoincrement=False, nullable=True))
    ...
    op.drop_table('notes_maj', schema='infolica')
    # ### end Alembic commands ###
