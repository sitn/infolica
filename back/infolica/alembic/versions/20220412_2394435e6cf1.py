"""preavis service externe

Revision ID: 2394435e6cf1
Revises: 3a2d967c76fc
Create Date: 2022-04-12 11:32:54.657881
...
def upgrade():
    ...
    op.drop_constraint('fk_controle_etape_etape_id_affaire_etape_index', 'controle_etape', type_='foreignkey')
    op.create_foreign_key(op.f('fk_controle_etape_etape_id_affaire_etape_index'), 'controle_etape', 'affaire_etape_index', ['etape_id'], ['id'], source_schema='infolica', referent_schema='infolica')
    op.drop_constraint('fk_controle_etape_type_affaire_affaire_type_id_affaire_type', 'controle_etape_type_affaire', type_='foreignkey')
    op.drop_constraint('fk_controle_etape_type_affaire_controle_etape_nom_contr_c621', 'controle_etape_type_affaire', type_='foreignkey')
    op.create_foreign_key(op.f('fk_controle_etape_type_affaire_affaire_type_id_affaire_type'), 'controle_etape_type_affaire', 'affaire_type', ['affaire_type_id'], ['id'], source_schema='infolica', referent_schema='infolica')
    op.create_foreign_key(op.f('fk_controle_etape_type_affaire_controle_etape_nom_controle_etape'), 'controle_etape_type_affaire', 'controle_etape', ['controle_etape_nom'], ['nom'], source_schema='infolica', referent_schema='infolica')
    ...
    op.drop_constraint('fk_controle_geometre_old_affaire_id_affaire', 'controle_geometre_old', type_='foreignkey')
    op.drop_constraint('fk_controle_geometre_old_operateur_id_operateur', 'controle_geometre_old', type_='foreignkey')
    op.create_foreign_key(op.f('fk_controle_geometre_old_affaire_id_affaire'), 'controle_geometre_old', 'affaire', ['affaire_id'], ['id'], source_schema='infolica', referent_schema='infolica')
    op.create_foreign_key(op.f('fk_controle_geometre_old_operateur_id_operateur'), 'controle_geometre_old', 'operateur', ['operateur_id'], ['id'], source_schema='infolica', referent_schema='infolica')
    ...
    op.drop_constraint('fk_emolument_emolument_affaire_id_emolument_affaire', 'emolument', type_='foreignkey')
    op.drop_constraint('fk_emolument_tableau_emolument_id_tableau_emoluments', 'emolument', type_='foreignkey')
    ...
    op.drop_constraint('fk_emolument_affaire_affaire_id_affaire', 'emolument_affaire', type_='foreignkey')
    op.create_foreign_key(op.f('fk_emolument_affaire_affaire_id_affaire'), 'emolument_affaire', 'affaire', ['affaire_id'], ['id'], source_schema='infolica', referent_schema='infolica')
    op.drop_constraint('fk_emolument_affaire_repartition_emolument_affaire_id_e_b164', 'emolument_affaire_repartition', type_='foreignkey')
    op.drop_constraint('fk_emolument_affaire_repartition_facture_id_facture', 'emolument_affaire_repartition', type_='foreignkey')
    op.create_foreign_key(op.f('fk_emolument_affaire_repartition_facture_id_facture'), 'emolument_affaire_repartition', 'facture', ['facture_id'], ['id'], source_schema='infolica', referent_schema='infolica')
    op.create_foreign_key(op.f('fk_emolument_affaire_repartition_emolument_affaire_id_emolument_affaire'), 'emolument_affaire_repartition', 'emolument_affaire', ['emolument_affaire_id'], ['id'], source_schema='infolica', referent_schema='infolica')
    ...
    op.drop_constraint('fk_notes_maj_operateur_id_operateur', 'notes_maj', type_='foreignkey')
    op.create_foreign_key(op.f('fk_notes_maj_operateur_id_operateur'), 'notes_maj', 'operateur', ['operateur_id'], ['id'], source_schema='infolica', referent_schema='infolica')
    ...
    op.drop_constraint('fk_operateur_role_id_role', 'operateur', type_='foreignkey')
    ...
    op.create_foreign_key(op.f('fk_operateur_service_id_service'), 'operateur', 'service', ['service_id'], ['id'], source_schema='infolica', referent_schema='infolica')
    ...
    op.add_column('preavis', sa.Column('etape', sa.Text(), nullable=True))
    ...
    op.create_foreign_key(op.f('fk_preavis_operateur_sgrf_id_operateur'), 'preavis', 'operateur', ['operateur_sgrf_id'], ['id'], source_schema='infolica', referent_schema='infolica')
    op.create_foreign_key(op.f('fk_preavis_operateur_service_id_operateur'), 'preavis', 'operateur', ['operateur_service_id'], ['id'], source_schema='infolica', referent_schema='infolica')
...
def downgrade():
    ...
    op.drop_constraint(op.f('fk_preavis_operateur_service_id_operateur'), 'preavis', schema='infolica', type_='foreignkey')
    op.drop_constraint(op.f('fk_preavis_operateur_sgrf_id_operateur'), 'preavis', schema='infolica', type_='foreignkey')
    ...
    op.drop_column('preavis', 'etape')
    op.drop_column('preavis', 'operateur_service_id')
    op.drop_column('preavis', 'operateur_sgrf_id')
    op.drop_constraint(op.f('fk_operateur_service_id_service'), 'operateur', schema='infolica', type_='foreignkey')
    op.drop_constraint(op.f('fk_operateur_role_id_role'), 'operateur', schema='infolica', type_='foreignkey')
    op.create_foreign_key('fk_operateur_role_id_role', 'operateur', 'role', ['role_id'], ['id'])
    ...
    op.drop_constraint(op.f('fk_notes_maj_operateur_id_operateur'), 'notes_maj', schema='infolica', type_='foreignkey')
    op.create_foreign_key('fk_notes_maj_operateur_id_operateur', 'notes_maj', 'operateur', ['operateur_id'], ['id'])
    ...
    op.drop_constraint(op.f('fk_emolument_affaire_repartition_emolument_affaire_id_emolument_affaire'), 'emolument_affaire_repartition', schema='infolica', type_='foreignkey')
    op.drop_constraint(op.f('fk_emolument_affaire_repartition_facture_id_facture'), 'emolument_affaire_repartition', schema='infolica', type_='foreignkey')
    op.create_foreign_key('fk_emolument_affaire_repartition_facture_id_facture', 'emolument_affaire_repartition', 'facture', ['facture_id'], ['id'])
    op.create_foreign_key('fk_emolument_affaire_repartition_emolument_affaire_id_e_b164', 'emolument_affaire_repartition', 'emolument_affaire', ['emolument_affaire_id'], ['id'])
    op.drop_constraint(op.f('fk_emolument_affaire_affaire_id_affaire'), 'emolument_affaire', schema='infolica', type_='foreignkey')
    op.create_foreign_key('fk_emolument_affaire_affaire_id_affaire', 'emolument_affaire', 'affaire', ['affaire_id'], ['id'])
    ...
    op.create_foreign_key('fk_emolument_tableau_emolument_id_tableau_emoluments', 'emolument', 'tableau_emoluments', ['tableau_emolument_id'], ['id'])
    op.create_foreign_key('fk_emolument_emolument_affaire_id_emolument_affaire', 'emolument', 'emolument_affaire', ['emolument_affaire_id'], ['id'])
    ...
    op.drop_constraint(op.f('fk_controle_geometre_old_operateur_id_operateur'), 'controle_geometre_old', schema='infolica', type_='foreignkey')
    op.drop_constraint(op.f('fk_controle_geometre_old_affaire_id_affaire'), 'controle_geometre_old', schema='infolica', type_='foreignkey')
    op.create_foreign_key('fk_controle_geometre_old_operateur_id_operateur', 'controle_geometre_old', 'operateur', ['operateur_id'], ['id'])
    op.create_foreign_key('fk_controle_geometre_old_affaire_id_affaire', 'controle_geometre_old', 'affaire', ['affaire_id'], ['id'])
    ...
    op.drop_constraint(op.f('fk_controle_etape_type_affaire_controle_etape_nom_controle_etape'), 'controle_etape_type_affaire', schema='infolica', type_='foreignkey')
    op.drop_constraint(op.f('fk_controle_etape_type_affaire_affaire_type_id_affaire_type'), 'controle_etape_type_affaire', schema='infolica', type_='foreignkey')
    op.create_foreign_key('fk_controle_etape_type_affaire_controle_etape_nom_contr_c621', 'controle_etape_type_affaire', 'controle_etape', ['controle_etape_nom'], ['nom'])
    op.create_foreign_key('fk_controle_etape_type_affaire_affaire_type_id_affaire_type', 'controle_etape_type_affaire', 'affaire_type', ['affaire_type_id'], ['id'])
    op.drop_constraint(op.f('fk_controle_etape_etape_id_affaire_etape_index'), 'controle_etape', schema='infolica', type_='foreignkey')
    op.create_foreign_key('fk_controle_etape_etape_id_affaire_etape_index', 'controle_etape', 'affaire_etape_index', ['etape_id'], ['id'])
