...
def upgrade():
    # Create schema
    op.execute("create schema infolica")
    ...
    sa.Column('id', sa.BigInteger(), nullable=False),
    sa.Column('nom', sa.Text(), nullable=False),
    sa.ForeignKeyConstraint(['id'], ['client.id'], name=op.f('fk_client_entreprise_id_client')),
    ...
    sa.ForeignKeyConstraint(['id'], ['client.id'], name=op.f('fk_client_personne_id_client')),
    ...
    sa.Column('cadastre_id', sa.BigInteger(), nullable=False),
    sa.Column('nom', sa.Text(), nullable=False),
    sa.ForeignKeyConstraint(['cadastre_id'], ['cadastre.id'], name=op.f('fk_plan_cadastre_id_cadastre')),
    ...
    sa.ForeignKeyConstraint(['sap'], ['facture.sap'], name=op.f('fk_facture_partielle_sap_facture')),
...
def downgrade():
    ...
    op.drop_table('numero_plan', schema='infolica')
    op.drop_table('facture_partielle', schema='infolica')
    op.drop_table('emoluments_rf', schema='infolica')
    op.drop_table('relation_affaire_client', schema='infolica')
    op.drop_table('modification_affaire', schema='infolica')
    op.drop_table('etape_affaire', schema='infolica')
    op.drop_table('affaire_numero', schema='infolica')
    op.drop_table('numero', schema='infolica')
    op.drop_table('plan', schema='infolica')
    op.drop_table('facture', schema='infolica')
    op.drop_table('envoi_document', schema='infolica')
    op.drop_table('client_personne', schema='infolica')
    op.drop_table('client_entreprise', schema='infolica')
    op.drop_table('remarque_affaire', schema='infolica')
    ...
    op.drop_table('relation_type', schema='infolica')
    ...
    op.drop_table('emoluments_rf_parametres', schema='infolica')
    op.drop_table('emoluments_mo_parametres', schema='infolica')
    op.drop_table('emoluments_mo', schema='infolica')
    op.drop_table('document', schema='infolica')
    op.drop_table('relation_affaire_client_type', schema='infolica')
    op.drop_table('client', schema='infolica')
    op.drop_table('statut_affaire', schema='infolica')
