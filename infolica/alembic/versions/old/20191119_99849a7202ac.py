...
Revision ID: 99849a7202ac
Revises: 23699963ba13
Create Date: 2019-11-19 15:58:53.819427
...
def upgrade():
    ...
    sa.Column('nom', sa.Text(), nullable=False),
    sa.ForeignKeyConstraint(['client_id'], ['client.client.id'], name=op.f('fk_client_entreprise_client_id_client')),
    schema='client'
    )
    ...
    sa.ForeignKeyConstraint(['client_id'], ['client.client.id'], name=op.f('fk_client_personne_client_id_client')),
    schema='client'
    )
    ...
    sa.ForeignKeyConstraint(['facture_sap'], ['facture.facture.sap'], name=op.f('fk_facture_partielle_facture_sap_facture')),
    schema='facture'
    )
...
def downgrade():
    ...
    op.drop_table('constant', schema='general')
